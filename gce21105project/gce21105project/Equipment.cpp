...
// Tents constructor
tent::tent(std::string itemCode, std::string itemName, std::string brand, std::string equipmentType, std::string dateOfPurchase, std::string condition, std::string status, int numOfPeopleUse, std::string tentType, int numOfDoors, bool doubleLayer, std::string color) :
	Equipment(itemCode, itemName, brand, equipmentType, dateOfPurchase, condition, status)
{
...
// Stoves constructor
stove::stove(std::string itemCode, std::string itemName, std::string brand, std::string equipmentType, std::string dateOfPurchase, std::string condition, std::string status, std::string stoveType, std::string fuelType) : 
	Equipment(itemCode, itemName, brand, equipmentType, dateOfPurchase, condition, status)
{
