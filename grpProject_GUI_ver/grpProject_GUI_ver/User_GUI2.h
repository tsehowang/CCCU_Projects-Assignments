...
namespace grpProjectGUIver {
	...
	/// <summary>
	/// Summary for User_GUI2
	/// </summary>
	public ref class User_GUI2 : public System::Windows::Forms::Form
	{
	public:
		User_GUI2(void)
		{
	...
	public:
		User_GUI2(System::Windows::Forms::Form ^ parentForm)
		{
			InitializeComponent();
			goback = parentForm;
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(User_GUI2::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &User_GUI2::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &User_GUI2::button1_Click);
			// 
			// button_exit
			// 
			...
			this->button_exit->Click += gcnew System::EventHandler(this, &User_GUI2::button_exit_Click);
			// 
			// label1
			// 
			...
			this->Name = L"User_GUI2";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"User_GUI2";
			this->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &User_GUI2::User_GUI2_MouseDown);
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &User_GUI2::User_GUI2_MouseMove);
			this->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &User_GUI2::User_GUI2_MouseUp);
...
#pragma endregion
	...
	private: System::Void User_GUI2_MouseMove(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		if (this->dragging) {
			Point currentScreenPos = PointToScreen(e->Location);
			Location = Point(currentScreenPos.X - this->offset.X, currentScreenPos.Y - this->offset.Y);
		}
	}
	private: System::Void User_GUI2_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = true;
		this->offset = Point(e->X, e->Y);
	}
	private: System::Void User_GUI2_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = false;
	}
};
}
