...
namespace grpProjectGUIver {
	...
	/// <summary>
	/// Summary for Admin_Update
	/// </summary>
	public ref class Admin_Update : public System::Windows::Forms::Form
	{
	public:
		Admin_Update(void)
		{
	...
	public:
		Admin_Update(System::Windows::Forms::Form ^ parentForm)
		{
			InitializeComponent();
			goback = parentForm;
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Admin_Update::typeid));
			...
			this->button_exit->Click += gcnew System::EventHandler(this, &Admin_Update::button_exit_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(30, 843);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(88, 30);
			this->button1->TabIndex = 36;
			this->button1->Text = L"Okay";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Admin_Update::button1_Click);
			// 
			// label5
			// 
			...
			this->label5->Location = System::Drawing::Point(26, 885);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(382, 19);
			this->label5->TabIndex = 35;
			this->label5->Text = L"*Please use the dropdown list to update the condition";
			// 
			// label4
			// 
			...
			this->label4->Location = System::Drawing::Point(26, 808);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(524, 23);
			this->label4->TabIndex = 33;
			this->label4->Text = L"Please press the Okay button to accept all changes";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(24, 555);
			...
			this->label1->Location = System::Drawing::Point(24, 92);
			...
			this->dataGridView3->Location = System::Drawing::Point(18, 592);
			...
			this->dataGridView2->Location = System::Drawing::Point(18, 357);
			...
			this->dataGridView1->Location = System::Drawing::Point(18, 127);
			...
			this->Name = L"Admin_Update";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Admin_Update";
			this->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Admin_Update::Admin_Update_MouseDown);
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Admin_Update::Admin_Update_MouseMove);
			this->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Admin_Update::Admin_Update_MouseUp);
...
#pragma endregion
	...
	private: System::Void Admin_Update_MouseMove(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		if (this->dragging) {
			Point currentScreenPos = PointToScreen(e->Location);
			Location = Point(currentScreenPos.X - this->offset.X, currentScreenPos.Y - this->offset.Y);
		}
	}
	private: System::Void Admin_Update_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = true;
		this->offset = Point(e->X, e->Y);
	}
	private: System::Void Admin_Update_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = false;
	}
	};
}
