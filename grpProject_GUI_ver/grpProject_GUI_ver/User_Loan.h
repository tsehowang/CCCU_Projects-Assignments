...
namespace grpProjectGUIver {
	...
	/// <summary>
	/// Summary for User_Loan
	/// </summary>
	public ref class User_Loan : public System::Windows::Forms::Form
	{
	public:
		User_Loan(void)
		{
	...
	public:
		User_Loan(System::Windows::Forms::Form ^ parentForm)
		{
			InitializeComponent();
			goback = parentForm;
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(User_Loan::typeid));
			...
			this->label3->Location = System::Drawing::Point(24, 557);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Century Gothic", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(24, 322);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Century Gothic", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(24, 94);
			...
			this->dataGridView3->Location = System::Drawing::Point(18, 594);
			...
			this->dataGridView2->Location = System::Drawing::Point(18, 359);
			...
			this->dataGridView1->Location = System::Drawing::Point(18, 129);
			...
			this->button_exit->Location = System::Drawing::Point(893, 34);
			this->button_exit->Name = L"button_exit";
			this->button_exit->Size = System::Drawing::Size(89, 30);
			this->button_exit->TabIndex = 15;
			this->button_exit->Text = L"Back";
			this->button_exit->UseVisualStyleBackColor = false;
			this->button_exit->Click += gcnew System::EventHandler(this, &User_Loan::button_exit_Click);
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Century Gothic", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(26, 839);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(551, 23);
			this->label4->TabIndex = 22;
			this->label4->Text = L"Type the Item Code of the items that you want to loan:";
			// 
			// textBox1
			// 
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Century Gothic", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(30, 881);
			...
			this->label5->Location = System::Drawing::Point(26, 916);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Century Gothic", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(390, 881);
			...
			this->Name = L"User_Loan";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"User_Loan";
			this->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &User_Loan::User_Loan_MouseDown);
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &User_Loan::User_Loan_MouseMove);
			this->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &User_Loan::User_Loan_MouseUp);
...
#pragma endregion
	...
	private: System::Void User_Loan_MouseMove(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		if (this->dragging) {
			Point currentScreenPos = PointToScreen(e->Location);
			Location = Point(currentScreenPos.X - this->offset.X, currentScreenPos.Y - this->offset.Y);
		}
	}
	private: System::Void User_Loan_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = true;
		this->offset = Point(e->X, e->Y);
	}
	private: System::Void User_Loan_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = false;
	}
};
}
